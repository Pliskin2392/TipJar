...
1) Install **RevenueCat** in your project
...
3) Go to **Features** > **In-App Purchases** and add new as follow 
...
**NOTE:** If your **In-App purchase** has a status of **Missing Metadata**, it means that something is missing and this could prevent **RevenueCat** from getting it
...
This key will be used when we configure RevenueCat's project
...
2) Select **App Store app**, App Bundle ID is the one you find in your Xcode project under **Signing & Capabilities** and set the key secret previously created in your project inside **App Store Connect**
...
Click on your new offering and create New Package
...
You can select a default identifier depending on the recurrence of your In-App purchase but in this case as we are creating a tip jar, I will put a custom identifier with the title of each In-App purchases
...
After you created all your needed it **Packages**
...
You will need to assing your products to each package as follow 
...
And select the corresponding **Product**
...
And then paste that code into you app 

<img width="654" alt="image" src="https://user-images.githubusercontent.com/48497638/226210898-5e744cb9-9dea-4fb3-9692-81222575a6a4.png">

## Step 5 

Testing your app

If you run your app yo should be able to see all your In-App Purchases that are in status **Ready to Submit**
